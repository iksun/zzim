...
class UserLoginExecutorTest {
    ...
    void sut_login_success() {
        UserLoginExecutor sut = new UserLoginExecutor(new UserStubRepository(makeTestData()), new JwtTokenProvider());
    ...
    void sut_login_fail_id_not_exist() {
        ...
        var sut = new UserLoginExecutor(new UserStubRepository(testData), new JwtTokenProvider());
